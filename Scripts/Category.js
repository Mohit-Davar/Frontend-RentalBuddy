...
function generateVehicleCategory(category, example, price, seats, doors, url) {
    return (
        VehicleCategoryContainer.innerHTML = VehicleCategoryContainer.innerHTML + `
            <div class="card flex flex-col bg-white md:w-[350px] h-[450px] sm:px-9 px-4 pt-12 pv-5 relative z-10 w-full">
...
const VehicleCategories = [
    ...
    new VehicleCategory("SUV", "Range Rover and Similar", "65", "7", "4", "Images/FortunerWhite.png")
