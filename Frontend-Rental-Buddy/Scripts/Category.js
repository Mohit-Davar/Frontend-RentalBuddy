...
const VehicleCategories = [
    new VehicleCategory("Economy", "Maruti Suzuki and Similar", "25", "5", "4", "Images/SkodaCar.webp"),
    new VehicleCategory("Luxury", "Mini Cooper and similar", "100", "4", "4", "Images/MiniCooper.webp"),
    new VehicleCategory("Premium", "Lamborghini and Similar", "200", "2", "2", "Images/Porsche.webp"),
    new VehicleCategory("EV", "Tata Punch and Similar", "55", "5", "4", "Images/Tesla.webp"),
    new VehicleCategory("Offroad", "G Wagon and Similar", "60", "5", "4", "Images/Thar.webp"),
    new VehicleCategory("SUV", "Range Rover and Similar", "65", "7", "4", "Images/LandRover.webp")
